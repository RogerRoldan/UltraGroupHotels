...
public record BookingResponse(Guid Id, Guid UserId, Guid RoomId, DateRangeResponse BookingPeriod, PriceSummaryBookingResponse PriceSummary, DateTime CreatedAt, string StatusBooking, EmergencyContactReponse EmergencyContact);
